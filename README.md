...
framing and 1 KiB for the request. Reads follow `Content-Length` or chunked
framing so a small final body fragment does not reserve another large block of
quota.
